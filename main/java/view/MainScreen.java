...
public class MainScreen extends javax.swing.JFrame {
    ...
    //responsavel pela criação da parte visual do componente
    ...
    private void initComponents() {
        ...
        EmptyListSubtitle.setText("Clique no botão \"+\" para adicionar alguma tarefa");
    ...
    private void TasksAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TasksAddMouseClicked
        ...
        if (projectIndex != -1) {
            ...
            //atualiza a lista depois de que a janela fecha (dps de salvo) 
    ...
    public void decorateTableTasks() {
        ...
        //utiliza a customização ao inves da padronização default
        ...
        jTableTasks.setAutoCreateRowSorter(true);//cria uma ordenação automatica por coluna
    ...
    private void initComponentsModel() {
        ...
        //força a seleção do primeiro projeto
    ...
    //guarda as informaçoes dos projetos do banco e descreve no model
    public void loadProjects() {
        ...
        //componente grafico padrão jlist altera o model para trabalhar com o model definido acima so trabalha com string
